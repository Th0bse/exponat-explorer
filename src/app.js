...
class App {
    ...
    constructor() {
        this.exponate=[];
        this.einlesen();
        this.lastClickedExponat = "Maya Kopf";
    ...
    addExponat(link, titel, kuenstler, ort, erstelldatum, ausstellungszeitraum,wert, ausstellungsort,beschreibung,epoche) {
        let einExpo = [link, titel, kuenstler, ort, erstelldatum, ausstellungszeitraum,wert, ausstellungsort,beschreibung,epoche];
    ...
    removeExponat(name) {
        for (let i = 0; i < this.exponate.length; i++) {
...
=======
>>>>>>> 4cd3ec0a290ae4862b0b991c7da5f67e85646613
    }
